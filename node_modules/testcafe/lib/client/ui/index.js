				...
				"ui": {
					...
					"status-bar": {
						...
						"index.js": function (exports, module, require) {
							...
							var REGULAR_VIEW_SEQUENCE = [VIEWS.onlyIcon, VIEWS.onlyIconAndFixture];
							var WAITING_VIEW_SEQUENCE = [VIEWS.onlyIcon, VIEWS.hideFixture, VIEWS.all];
							var DEBUGGING_VIEW_SEQUENCE = [VIEWS.onlyButtons, VIEWS.hideUnlockArea, VIEWS.hideStatus, VIEWS.hideFixture, VIEWS.all];
							...
							var StatusBar = function (_serviceUtils$EventEm) {
							    ...
							    StatusBar.prototype._createStatusArea = function _createStatusArea() {
							        ...
							        if (browserUtils.isMacPlatform) this.statusDiv.style.marginTop = '11px';
							    ...
							    StatusBar.prototype._getActualViewSequence = function _getActualViewSequence() {
							        if (this.state.debugging) return DEBUGGING_VIEW_SEQUENCE;

							        if (this.state.waiting) return WAITING_VIEW_SEQUENCE;

							        return REGULAR_VIEW_SEQUENCE;
							    };

							    StatusBar.prototype._calculateActualView = function _calculateActualView(windowWidth) {
							        return this._getActualViewSequence().reduce(function (currentView, nextView) {
							            return currentView.maxSize >= windowWidth ? currentView : nextView;
							        });
							    };
